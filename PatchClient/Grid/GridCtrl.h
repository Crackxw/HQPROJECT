...
#define TESTMESSAGE				90001
#define USEWRONGCHAR			90002
...
protected:
    ...
    LRESULT SendMessageToParent(int nRow, int nCol, int nMessage, LPCTSTR szData = " ",  LPCTSTR a_szStr = NULL );
