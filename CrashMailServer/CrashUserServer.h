...
#ifndef __CRASH_USER_SERVER_H_INCLUDED__
#define __CRASH_USER_SERVER_H_INCLUDED__
...
public : 
	...
	void SendCrashInfoList
	(
		ON_P_RESP_SEARCHCRASHINFO_LIST pCrashList, 
