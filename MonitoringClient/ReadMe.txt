========================================================================
		ActiveX Control DLL : MONITORINGCLIENT
========================================================================

ControlWizard has created this project for your MONITORINGCLIENT ActiveX Control
...
that make up your MONITORINGCLIENT ActiveX Control DLL.

MonitoringClient.dsp
...
MonitoringClient.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
MonitoringClient control:

MonitoringClientCtl.h
	This file contains the declaration of the CMonitoringClientCtrl C++ class.

MonitoringClientCtl.cpp
	This file contains the implementation of the CMonitoringClientCtrl C++ class.

MonitoringClientPpg.h
	This file contains the declaration of the CMonitoringClientPropPage C++ class.

MonitoringClientPpg.cpp
	This file contains the implementation of the CMonitoringClientPropPage C++ class.

MonitoringClientCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMonitoringClientCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file MonitoringClient.rc.
